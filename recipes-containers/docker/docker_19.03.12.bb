...
SRC_URI = "\
	git://github.com/docker/docker-ce.git;branch=19.03;protocol=https;name=docker \
	git://github.com/docker/libnetwork.git;branch=bump_19.03;protocol=https;name=libnetwork;destsuffix=git/libnetwork \
